...
\caption{Development procedure of existing and proposed frameworks}
    ...
    \begin{tabular}{c||c}
        ...
        Existiting framework &    (1) + (2) + (3)    \\ %\hline
...
It was confirmed that the execution time was within the theoretical value which is 
\begin{displaymath}
...
As shown in Fig. \ref{fig:eval_synchronization}, the execution time is within the theoretical value, which indicates successful synchronization of multiple RiteVM tasks.
...
%%%%%%%%%%%% Reference %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibliographystyle{article/jssst}
\bibliography{ref}
...
{
Hiroshi Oyama received Dr. Engineering degree from Gifu University in 2002.
...
\chosha{Takuya Azumi}
{
Takuya Azumi is an Assistant Professor at the Graduate School of Engineering Science, Osaka University. 
