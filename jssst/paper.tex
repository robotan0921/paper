...
As shown in Fig.\ref{fig:eval_synchronization}, the time is within the theoretical value respectively, which indicates successful synchronization of multiple RiteVM tasks.
