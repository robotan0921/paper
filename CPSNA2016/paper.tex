...
Cyber Physical Systems (CPS) is the important keyword for enriching our lives.
...
We decided a program with 100,000 loops as an mruby application for the evaluation of execution time.
...
\end{figure}
\subsubsection{Execution Time of Singletasking, Co-routine, and Proposed Multitasking}
Figure \ref{fig:comparison_s_c_m} shows that the proposed design is superior to co-routine in terms of execution time.
...
Although the overhead is larger as the number of RiteVMs increases, it also spread the difference between multitasking and co-routine.
Therefore, the scheduler enables developers multitasking as the more efficient approach than co-routine.
