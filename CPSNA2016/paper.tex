...
The proposed framework is an extension of mruby on TECS\footnote{mruby on TECS is explained in detail in \cite{par:mrubyonTECS}}, and utilizes mruby and TECS, which are described in Appendices \ref{apn:mruby} and \ref{apn:TECS}.
