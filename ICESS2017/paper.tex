...
Furthermore, the advantages of the dynamic connection in terms of the memory consumption and low overhead of the TECS adapter are demonstrated.
...
\end{lstlisting}
\vspace{-2mm} \caption{Signature and celltype description for the dynamic connection}
...
\end{lstlisting}
\vspace{-2mm} \caption{Accept function (a dynamic connection example)}
...
The authors would like to thank Hiroaki Nagashima for supporting this research.
