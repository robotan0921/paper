...
Besides, as another method, {\it delay}, a service call of \$micro\$ITRON, can be used for multitasking, but it leaves the scheduling to developers such as co-routine.
In the proposed framework, as an approach for multitask processing, {\it rotateReadyQueue}, a service call of \$micro\$ITRON, is implemented.
...
The {\it rotateReadyQueue} is a service call of \$micro\$ITRON.
...
Cyclic handlers based on ITRON are described in detail \cite{ITRON_spec}.
...
The interpreter of the Owl system is the same as that of python-on-a-chip \cite{python-on-a-chip}.
