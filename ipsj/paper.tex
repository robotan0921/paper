...
The proposed framework enables that that mruby program calls TINET, a TCP/IP protocol stack for use in embedded systems, functions.
In addition, this paper proposes two component-based functionality such as a componentized TINET called TINET+TECS and a componentized Two-Level Segregate Fit (TLSF) dynamic memory allocator called TLSF+TECS.
...
Section \ref{sec:System Model} introduces the system model and the basic technologies, i.e., TECS, mruby, and mruby on TECS.
...
Related work is discussed in Section \ref{sec:Related Work} and Section \ref{sec:Conclusion} concludes this paper.
...
\begin{figure}[t]
    ...
    \vspace{-1mm} \caption{System model of the proposed framework}
    \vspace{-2mm} \label{fig:SystemModel}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-2mm} \label{fig:component}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-1mm} \caption{Development flow using TECS}
    \vspace{-2mm} \label{fig:TECSFlow}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-1mm} \caption{mruby/RiteVM mechanism}
    \vspace{-2mm} \label{fig:mruby}
\end{figure}
...
\vspace{-1mm} \caption{mruby-TECS bridge}
\vspace{-2mm} \label{fig:mrubyTECSbridge}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-2mm} \label{fig:TINETHierarchyDiagram}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-2mm} \label{fig:ComponentProtocolStack}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-2mm} \label{fig:tMemoryAllocator}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-2mm} \label{fig:SendReceive}
\end{figure}
...
\vspace{-2mm} \label{src:SendReceive}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-2mm} \label{fig:DynamicConnection}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-2mm} \label{fig:DynamicConnectionUseCase}
\end{figure}
...
\end{lstlisting}
\vspace{-1mm} \caption{Signature and celltype description for the dynamic connection}
\vspace{-2mm} \label{src:DynamicCDLcode}
\end{figure}
...
\end{lstlisting}
\vspace{-1mm} \caption{Accept function (a dynamic connection example)}
\vspace{-2mm} \label{src:DynamicCcode}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-1mm} \caption{TLSF Algorithm}
    \vspace{-2mm} \label{fig:TLSF}
\end{figure}
...
\end{lstlisting}
\vspace{-1mm} \caption{Signature description of memory management}  
\vspace{-2mm} \label{src:TLSFSignature}
\end{figure}
...
\end{lstlisting}
\vspace{-1mm} \caption{Celltype description of TLSF memory allocator component}  
\vspace{-2mm} \label{src:TLSFCelltype}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-1mm} \caption{TLSF before componentization}
    \vspace{-2mm} \label{fig:WithoutTECS}
\end{figure}

\begin{figure}[t]
    \centering
    \includegraphics[width=8cm,clip]{figure/WithTECS.pdf}
    \vspace{-1mm} \caption{TLSF after componentization}
    \vspace{-2mm} \label{fig:WithTECS}
\end{figure}
...
\end{lstlisting}
\vspace{-1mm} \caption{Build description of TLSF memory allocator component}
\vspace{-2mm} \label{src:TLSFBuild}
\end{figure}
...
\end{lstlisting}
\vspace{-1mm} \caption{Example of TLSF memory allocator component}  
\vspace{-2mm} \label{src:TLSFC}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-1mm} \caption{Component description of RiteVM and TLSF+TECS}
    \vspace{-2mm} \label{fig:UseCase_mruby}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-1mm} \caption{Fixed-size and TLSF memory allocator components}
    \vspace{-2mm} \label{fig:UseCase_TINET}
\end{figure}
...
\end{lstlisting}
\vspace{-1mm} \caption{Example of mruby application}
\vspace{-2mm} \label{src:mruby}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-2mm} \label{fig:EvaluationOfExecutionTime}
\end{figure}
...
\begin{figure}[t]
    ...
    \vspace{-1mm} \caption{Component diagrams for without/with dynamic connection}
    \vspace{-2mm} \label{fig:ComparisonOfDynamicConnection}
\end{figure}
...
cell tTCPCEP TCPCEP_00n {
 ...
 \vspace{-2mm} \label{src:ComparisonOfCDL}
\end{figure}
