...
Developers do not need to insert and pull out repeatedly, and that improves the software development efficiency.
...
\begin{table*}[t]
    ...
    \begin{tabular}{c||c|ccc}
        & \shortstack{mruby bytecode loader\\using Bluetooth} & \shortstack{Preemptive-multitask\\(multi-VM)} & \shortstack{Nonpreemptive-multitask\\(co-routine)} & GIL \\ \hline
