...
%DIF ADD 0127_thesis.tex   Wed Jan 27 01:03:10 2016
%DIF < %%
%DIF -------
% %DIF > 
%DIF -------
...
\DIFdelbegin \DIFdel{This paper demonstrates }\DIFdelend \DIFaddbegin \DIFadd{Experimental results demonstrate }\DIFaddend the advantages of the proposed framework\DIFdelbegin \DIFdel{with experimental results}\DIFdelend .
\end{abstract}
...
\DIFdelbegin \DIFdel{Users }\DIFdelend \DIFaddbegin \DIFadd{Developers }\DIFaddend do not need to insert and pull out \DIFdelbegin \DIFdel{repeatedly, and that improves }\DIFdelend \DIFaddbegin \DIFadd{a SD card repeatedly and also to restart an OS.
...
\DIFdelbegin \DIFdel{Users can easily program multithreading.
Multithreaded }\DIFdelend \DIFaddbegin \DIFadd{Multitasked }\DIFaddend programing makes the range of software expand.
\end{enumerate}
...
\DIFaddbegin \DIFadd{The 100,000 times loop program is used as mruby application for evaluation of execution time.
